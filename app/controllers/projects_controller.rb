class ProjectsController < ApplicationController
  ...
  #GOTO projects/users_controller action: destroy
  ...
  #GOTO projects/users_controller action: index
  ...
  #GOTO projects/users_controller action: create
  ...
  #GOTO projects/users_controller action: reinvite
